        ...
        <div class="card overflow-hidden">
            <div class="px-6 sm:px-8 py-5 border-b border-slate-100 bg-gradient-to-r from-primary-50 to-white">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg sm:text-xl font-bold text-slate-800 tracking-tight">Tambah Produk Baru</h2>
                        <p class="text-xs text-slate-400 mt-0.5">Tambahkan item sparepart ke dalam etalase</p>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="kode" name="kode" value="{{ old('kode') }}"
                                   placeholder="Cth: PART-2024-001" class="form-input-clean" required>
                        ...
                        <div>
                            ...
                            <input type="text" id="nama" name="nama" value="{{ old('nama') }}"
                                   placeholder="Nama lengkap sparepart..." class="form-input-clean" required>
                        ...
                        <div>
                            ...
                            <div class="relative group" x-data="{
                                ...
                                <input type="text" x-model="formatted" @input="updateValue"
                                       placeholder="0" class="form-input-clean pl-12" required>
                        ...
                        <div>
                            ...
                            <x-custom-select 
                                ...
                                required 
                            />
                            @error('brand_id') <p class="form-error"><svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg> {{ $message }}</p> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            {{-- 
                                Konversi TIPE_KENDARAAN constant ke format [{id, nama}]
                                yang diharapkan oleh komponen x-custom-select.
                                Hasilnya: [['id'=>'motor','nama'=>'Motor'], ...]
                            --}}
                            <x-custom-select
                                name="tipe_kendaraan"
                                id="tipe_kendaraan"
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4"
                                  placeholder="Tuliskan detail spesifikasi dan kegunaan produk di sini..."
                        ...
                        <div class="upload-zone" 
                            ...
                            <div class="space-y-4 text-center w-full">
                                <template x-if="!croppedImage">
                                    <div class="py-4">
                                        <svg class="mx-auto h-12 w-12 text-slate-300 group-hover:text-primary-500 transition-colors" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                                        ...
                                        <p class="text-[10px] uppercase tracking-widest text-slate-400 mt-2">PNG, JPG, WebP (Maks. 2MB)</p>
                                    </div>
                                </template>

                                <template x-if="croppedImage">
                                    <div class="relative inline-block mt-2 group">
                                        <img :src="croppedImage" class="max-h-48 rounded-xl border border-slate-200 shadow-sm mx-auto">
                                        
                                        <!-- Tombol Hapus / Ganti -->
                                        <button type="button" @click="croppedImage = null; $refs.fileInput.value = ''; $refs.croppedInput.value = ''" 
                                        ...
                                        <p class="mt-2 text-xs font-bold text-slate-500">Gambar yang Selesai di-Crop</p>
                                    </div>
                                </template>
                            </div>
                        </div>
